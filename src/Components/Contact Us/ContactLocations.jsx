...
const ContactLocations = () => {
  const locations = [
    {
      ...
      city: "Hyderabad.",
      address:
        "401, 8-3-6-5/1/1/4, Astral Hasini Residency, J.P. Nagar, Yella Reddy Guda, Hyderabad - 500073, Telangana",
      phone: "+91 9701888071",
  ...
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8 flex">
      <div className="max-w-7xl  flex flex-col space-y-10">
        {locations.map((loc, idx) => (
          <div
            key={idx}
            className="flex flex-col space-y-4 border-b border-gray-300 pb-6 w-full sm:w-auto"
          >
