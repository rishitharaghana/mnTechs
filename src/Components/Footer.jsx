import { Camera, Facebook, Instagram, MapPin, Youtube } from "lucide-react";
      ...
      <section className="pt-16 pb-7 bg-gray-900">
        ...
        <div className="flex sm:flex-row items-center justify-between px-10 pt-7">
          <span className="text-sm font-normal text-gray-400">
           ...
           <div className="flex sm:flex-row items-center  text-gray-100 justify-between px-10 pt-7">All Rights Reserved.</div>
