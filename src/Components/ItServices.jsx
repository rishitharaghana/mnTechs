...
const ServicesSection = () => {
  ...
  return (
    <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-background overflow-hidden">
      {/* Top corner pattern replaced with image */}
      <div
  className="absolute z-50 top-0 right-0 w-32 h-32 opacity-10"
  style={{
    backgroundImage: `url('/ITservices Pattern.png')`, // Root-relative path from public
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            <div className="flex items-center mb-12">
              <h3 className="text-2xl sm:text-3xl font-600 text-[#121820]">IT Services</h3>
            </div>
          ...
          <div>
            <div className="flex items-center mb-12">
              <h3 className="text-2xl sm:text-3xl font-600 text-[#121820]">IT Solutions</h3>
            </div>
            <div className="flex items-center my-8">
              <div className="w-4 h-0.5 bg-orange-500"></div>
              <div className="flex-1 h-px bg-gray-800"></div>
  ...
  return (
    <div className="group flex items-start gap-6 p-4 rounded-lg transition-all duration-300 hover:bg-gray-300">
      ...
      <div className="relative flex-shrink-0">
        ...
        {/* Orange dot indicator - positioned below the icon */}
