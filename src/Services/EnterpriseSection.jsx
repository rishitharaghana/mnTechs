            ...
            <div className="relative">
              ...
              <div className="absolute bottom-4 right-4 sm:bottom-8 sm:right-8 bg-white rounded-xl shadow-lg p-4 sm:p-6 max-w-xs">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex">
                    {[1, 2, 3, 4].map((star) => (
                      <svg key={star} className="w-5 h-5 text-orange-400 fill-current" viewBox="0 0 20 20">
          ...
          <div className="order-1 lg:order-2 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base sm:text-lg text-foreground font-medium">Accelerate innovation.</span>
              </div>
              
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0"></div>
                <span className="text-base sm:text-lg text-foreground font-medium">With world-class tech teams.</span>
              </div>
              
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0"></div>
                <span className="text-base sm:text-lg text-foreground font-medium">Our all service offerings to enhance.</span>
              </div>
              
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0"></div>
                <span className="text-base sm:text-lg text-foreground font-medium">Simply drag, drop and customize.</span>
              </div>
            </div>
          </div>
        </div>
