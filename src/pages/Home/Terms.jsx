      ...
      <section className="relative z-10 px-4 sm:px-6 md:px-10 py-16 bg-white">
        <div className="max-w-4xl mx-auto text-gray-800">
          ...
          <p className="mb-6 text-base sm:text-lg text-gray-500">
            These terms and conditions apply to the website and services (hereinafter referred to as "Services") provided by MetricsNow Tech Solutions Pvt Ltd (hereinafter referred to as "Service Provider") through <a href="https://www.mntechs.com" className="text-orange-500 hover:underline">www.mntechs.com</a> as a Free and Subscription-based service.
          </p>
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-4">2. Platform Description</h2>
          <p className="mb-6 text-base sm:text-lg">
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-4">4. Verification and Due Diligence</h2>
          <p className="mb-6 text-base sm:text-lg">
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-4">5. Disclaimers</h2>
          <p className="mb-6 text-base sm:text-lg">
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-4">6. User Conduct</h2>
          <p className="mb-6 text-base sm:text-lg">
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-4">7. Modification of Terms</h2>
          <p className="mb-6 text-base sm:text-lg">
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-4">8. Governing Law</h2>
          <p className="mb-6 text-base sm:text-lg">
            These terms are governed by and construed in accordance with the laws of Hyderabad, Telangana, India.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold mb-4">9. Contact Information</h2>
          <p className="mb-6 text-base sm:text-lg">
          ...
          <p className="mb-2 text-base sm:text-lg">
            <strong>Address</strong>: MetricsNow Tech Solutions Pvt Ltd, [Hasini Residency 8-3-668/5,Jaya Prakash Nagar ,Imam Guda,Padala Ramareddy Colony ,Yousufguda,Hyderabad, Telangana, India]
          </p>
          <p className="mb-2 text-base sm:text-lg">
            <strong>Phone</strong>: [+91 9701888071]
          </p>
